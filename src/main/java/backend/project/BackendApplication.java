...
public class BackendApplication {
	...
	public CommandLineRunner mappingDemo(
		...
		return args -> {
			...
			Empresa employeeSaved = employeeRepository.save(new Empresa(Long.valueOf(0),"Cinthy","Lima",15000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Gonzalo","Lima",15000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Gladys","Cuzco",5000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Walter","Lima",9000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Emma","Lima",10000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Ana Paula","Piura",1300.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Regina","Tacna",12000.0,null));
			employeeRepository.save(new Empresa(Long.valueOf(0),"Pilar","Piura",3000.0,null));
			...
			Empresa employeeFound = employeeRepository.findById(Long.valueOf(3)).get();

			//Una lista de objetos como resultado

			List<Empresa> employeeAll = employeeRepository.findAll();
			System.out.println("\nLista Completa");
			for(Empresa e: employeeAll) {
				System.out.println(e);
			}

			System.out.println("\nLista por Ciudad");
			List<Empresa> employeeCiudad= employeeRepository.findByCityOrderByNameDesc("Lima");
			for(Empresa e: employeeCiudad) {
				System.out.println(e);
			}

			System.out.println("\nLista por Ciudad y Nombre");
			List<Empresa> employeeCiudadNombre = employeeRepository.findByCityAndName("Lima","Gonzalo");
			for(Empresa e: employeeCiudadNombre) {
				System.out.println(e);
			}


			System.out.println("\nLista por similitud Nombre");
			List<Empresa> employeeNombreParecido = employeeRepository.findByNameContaining("G");
			for(Empresa e: employeeNombreParecido) {
				System.out.println(e);
			}
			...
			List<Empresa> employeeCiudadMenorSalario = employeeRepository.findByCityAndLowerSalaryJPQL("Lima", 10000.0);
			for(Empresa e: employeeCiudadMenorSalario) {
				System.out.println(e);
			}

			System.out.println("\nLista por Rango Salario");
			List<Empresa> employeeRangoSalario = employeeRepository.findBySalaryBetween(1000.0, 10000.0);
			for(Empresa e: employeeRangoSalario) {
				System.out.println(e);
			}
			...
			*/
			...
			Long idEmployeePromoted = Long.valueOf(8);
			Double newSalaryEmployeePromoted = 5000.0;
			Empresa e = employeeRepository.findById(idEmployeePromoted).get();
			e.setSalary(newSalaryEmployeePromoted);
			e.setId(idEmployeePromoted);
			Empresa employeePromoted =  employeeRepository.save(e);
			System.out.println("\n"+employeePromoted);
			...
			Empresa employee1 = employeeRepository.findById(Long.valueOf(2)).get();
			Empresa employee2 = employeeRepository.findById(Long.valueOf(4)).get();
			Empresa employee3 = employeeRepository.findById(Long.valueOf(6)).get();
			Empresa employee4 = employeeRepository.findById(Long.valueOf(7)).get();
			Empresa employee5 = employeeRepository.findById(Long.valueOf(8)).get();
